...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        delegate void DelegadoParaRecuperarForm1();
        ...
        private void CerrarForm2()
        {
            this.Close();
        }
        private void RecuperarForm1()
        {
            f1.Show();
        }
        private void FinalizarPartida(string j)
        {
            ...
            MessageBox.Show(mensaje+" "+campeon.Nombre + " ha ganado! \nPuntos: "+campeon.Puntos+"\nLa partida ha durado: "+ diferencia.ToString());

            if (yo.Color == 'y') 
            {
                string mensaje2 = "11/" + id + "/" + n_jug + "/" + diferencia.ToString() + "/";

                foreach (Jugador f in listajugadores)
                {
                    mensaje2 += f.Nombre + "/" + f.Puntos + "/" + f.Color + "/";
                }
            ...
            this.Invoke(new DelegadoParaCerrarForm2(CerrarForm2));
            // Mostrar el formulario secundario
            //this.Invoke(new DelegadoParaRecuperarForm1(RecuperarForm1));
        }
        ...
        public Form2(int n, int i, string nom, Socket srv, Form formulario1)
        {
            InitializeComponent();
            DefinirPartida(n);
            nombre = nom;
        ...
        private void DefinirPartida(int n)
        {
            ...
            if (n_jug < 3) timer1.Interval = 750;
            else timer1.Interval = 750;
