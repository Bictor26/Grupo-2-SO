...
namespace WindowsFormsApplication1
{
    ...
    public partial class Form1 : Form
    {
        ...
        delegate void DelegadoMostrarInvitar();
        ...
        private void MostrarInvitar()
        {
            invitar.Visible = true;
        }
        private void OcultarInvitar()
        {
            ...
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 2:      //Consulta 2 (Nu￺mero de partidas jugadas)
                        ...
                        break;
                    case 3:       //Consulta 3 (Record del jugador)
                        mensaje = trozos[1].Split('\0')[0];
                    ...
                    case 5: // Conectarse y desconectarse
                        ...
                        if (mensaje == "Conectado correctamente")
                        {
                            ...
                            RecordPersonal.Invoke(new DelegadoParaVisualizarTiempo(VisualizarTiempo));
                            ...
                            if (dataGridView1.Rows.Count > 1) invitar.Invoke(new DelegadoMostrarInvitar(MostrarInvitar));
                        }
                        else if (mensaje == "Desconectado correctamente")
                        {
                            dataGridView1.Invoke(new DelegadoParaActualizarLista(ActualizaGrid), new object[] { trozos });
                            if (dataGridView1.Rows.Count < 2) invitar.Invoke(new DelegadoMostrarInvitar(OcultarInvitar));
                        }
                        else
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (RecordPersonal.Checked)
            {  
                //Enviamos nombre y contraseña
        ...
        private void Jugar_Click(object sender, EventArgs e)
        {
            ...
            Form2 Form2 = new Form2(num_mapa, Identificador, nombre.Text, server, this);
            this.Hide();
