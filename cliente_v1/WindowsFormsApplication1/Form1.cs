...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
            ...
            while (true)
            {
                ...
                switch (codigo)
                {
                    ...
                    case 5: // Conectarse y desconectarse
                        ...
                        {
                            JugMasPunt.Invoke(new DelegadoParaVisualizarJugMasPunt(VisualizarJugMasPunt));
                            ColRob3.Invoke(new DelegadoParaVisualizarColRob3(VisualizarColRob3));
        ...
        private void invitar_Click(object sender, EventArgs e)
        {
            ...
            if (longitud > 4)
            {
                MessageBox.Show("4 Jugadores máximo");
            }
            else
            {
